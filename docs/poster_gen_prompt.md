...
- Hand-drawn illustration style, portrait orientation.
...
Please use nano banana pro to create the illustration based on the input provided below:

```
预测：德甲联赛第<NUM>轮 多特蒙德主场对阵门兴格拉德巴赫
预测结果：<JSON>
```
